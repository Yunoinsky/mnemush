...
echo "  - For DeepSeek Harness (DSH):"
echo "      dsh plugin --profile web add -w \"$PROJECT_ROOT/packages/mnemush-dsh\""
echo "      # then add to the profile's cordis.patch.yml (must use insert:):"
echo "      #   - insert:"
echo "      #       - id: mnemush"
echo "      #         name: mnemush-dsh"
echo "      #         config: { conceptLimit: 40 }"
